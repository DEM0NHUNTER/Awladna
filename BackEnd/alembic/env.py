...
# TODO: Replace these with your actual revision IDs
revision = 'yyyy_add_proper_tables'
down_revision = 'abcd1234_previous_migration'  # e.g. the head of your current migration chain
branch_labels = None
depends_on = None
