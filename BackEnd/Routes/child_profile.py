# BackEnd/Routes/child_profiles.py

# ─── Child Profiles API Routes ─────────────────────────────────────────────────
...
def create_child_profile(
    ...
    Automatically generates behavior- and emotion-based recommendations.
    """
...
def get_all_profiles(
    ...
    """
    Retrieve all child profiles belonging to the current user.
    """
...
def get_single_profile(
    ...
    """
    Retrieve details of a single child profile.
    """
...
def delete_child_profile(
    ...
    """
    Delete a child profile owned by the current user.
    """
    profile = db.query(ChildProfile).filter(
        ChildProfile.child_id == child_id,
        ChildProfile.user_id == current_user.user_id,
